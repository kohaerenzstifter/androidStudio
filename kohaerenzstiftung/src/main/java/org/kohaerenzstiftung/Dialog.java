...
public abstract class Dialog extends android.app.Dialog implements Dialogable {
	...
	public void onCreateContextMenu(ContextMenu menu, View v,
		...
		prepareContextMenu(menu, position);
	}

	protected abstract void prepareContextMenu(ContextMenu menu, int position);

	public int getDialogId() {
		return this.mDialogId;
	}

	public Dialog(StandardActivity activity, int layout, boolean cancelable) {
		super(activity);
